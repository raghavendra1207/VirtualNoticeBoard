	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (trypass.equals(okay))
		{
			...
			try
			{
				...
				rs1=st1.executeQuery("select * from FacOff where Name='"+comname+"'");
		...
		if(e.getSource()==b1)
		{
			...
			try
			{
				...
				String query="UPDATE FacOff SET Password='"+t1.getText()+"',Designation='"+t3.getText()+"'where Name='"+comname+"'";
		...
		if(e.getSource()==b2)
		{
			try
			{
				...
				String query="Delete from FacOff where Name='"+comname+"'";
