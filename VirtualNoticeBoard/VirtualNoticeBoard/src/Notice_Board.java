...
class Notice_Board extends JFrame implements ActionListener
{
	...
	Notice_Board()
	{
		...
		NoticeUpdate=new JMenu ("Notice Update"); NoticeUpdate.setMnemonic('N');
		NoticeUpdate.setFont(new Font("Dialog", Font.BOLD, 16));

		Exit=new JMenu ("About & Exit"); Exit.setMnemonic('x');
	...
	// adding MenuItem of Exit
		...
		ViewNotice.setBackground(Color.orange);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==asChief)
		{
			try
			{
			String s=JOptionPane.showInputDialog(this,"Enter Password for Chief Signup Form:");
			if (s.equals ("chief"))
			{
		...
		if(e.getSource()==asFaculty)
		{
			try
			{
			String t=JOptionPane.showInputDialog(this,"Enter Password for Faculty Signup Form:");
			if (t.equals ("faculty"))
			{
		...
		if(e.getSource()==asOfficial)
		{
			try
			{
			String u=JOptionPane.showInputDialog(this,"Enter Password for Official Signup Form:");
