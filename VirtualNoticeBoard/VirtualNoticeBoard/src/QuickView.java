...
{
	JLabel title2=new JLabel("View In Table",JLabel.CENTER);
	JTable t;

	TableShow(String row_Data[][], String col_Name[])
	{
...

{
	...
	JRadioButton rb1=new JRadioButton("Chief Notice");
	JRadioButton rb2=new JRadioButton("Faculty Notice");
	JRadioButton rb3=new JRadioButton("Official Notice");
	...
	public void actionPerformed(ActionEvent e)
	{
		try
		{
			if(e.getSource()==b1)
			{
				...
				{
					int ss1=0;
					rs=st.executeQuery("Select Notice.Name,Notice.YearBatch,Notice.Notice From Chief,Notice where Chief.Name=Notice.Name");
					rsmt=rs.getMetaData();
					...
					TableShow ts=new TableShow(row_Data, col_Name);
				}
				...
				{
					int ss1=0;
					rs=st.executeQuery("Select Notice.Name,Notice.YearBatch,Notice.Notice From FacOff,Notice where FacOff.Name=Notice.Name and FacOff.Type='Faculty'");
					rsmt=rs.getMetaData();
					int s22=rsmt.getColumnCount();
					...
					TableShow ts1=new TableShow(row_Data, col_Name);
				}
				...
				{
					int ss1=0;
					rs=st.executeQuery("Select Notice.Name,Notice.YearBatch,Notice.Notice From FacOff,Notice where FacOff.Name=Notice.Name and FacOff.Type='Official'");
					rsmt=rs.getMetaData();
					int s22=rsmt.getColumnCount();
					...
					TableShow ts2=new TableShow(row_Data, col_Name);
				}
			}
		}
