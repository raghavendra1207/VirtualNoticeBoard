...

{
	...
	public void dataConnection2()
	{
		...
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
			con2=DriverManager.getConnection("jdbc:mysql://localhost:3306/VNB","root","Graghu678");
	...
	public void dataConnection3()
	{
		...
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
			con3=DriverManager.getConnection("jdbc:mysql://localhost:3306/VNB","root","Graghu678");
	...
	public void dataConnection4()
	{
		...
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
			con4=DriverManager.getConnection("jdbc:mysql://localhost:3306/VNB","root","Graghu678");
	...
	public void dataConnection5()
	{
		...
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
			con5=DriverManager.getConnection("jdbc:mysql://localhost:3306/VNB","root","Graghu678");
	...
	public void dataConnection6()
	{
		...
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
			con6=DriverManager.getConnection("jdbc:mysql://localhost:3306/VNB","root","Graghu678");
	...
	public void dataConnection7()
	{
		...
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
			con7=DriverManager.getConnection("jdbc:mysql://localhost:3306/VNB","root","Graghu678");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		rs7=st7.executeQuery("select * from FacOff where Name='"+tryname+"'");
		try{
		while(rs7.next())
		{
		...
		if (trypass.equals(okay))
		{
			...
			{
				String comname=((String)com1.getSelectedItem());
				rs3=st3.executeQuery("select * from FacOff where Name='"+comname+"'");
		...
		if(e.getSource()==com2)
		{
			...
			try
			{
				...
				rs2=st2.executeQuery("select * from Notice where Name='"+comname+"' and YearBatch='"+comyear+"'");
		...
		if(e.getSource()==b2)
		{
			try
			{
				...
				String query="UPDATE Notice SET Notice='"+ta.getText()+"' where Name='"+comname+"'and YearBatch='"+comyear+"'";
		...
		if(e.getSource()==b3)
		{
			try
			{
				...
				String query="Delete from Notice where Name='"+comname+"' and YearBatch='"+comyear+"'";
